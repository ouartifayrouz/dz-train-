...
class HistoriqueTrajetsPage extends StatefulWidget {
  final String username; // <-- username passé lors de la connexion

  const HistoriqueTrajetsPage({super.key, required this.username});
            ...
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                final trajets = allDocs.where((doc) {
                  ...
                  final matchesUser = docUsername == widget.username;

                  return matchesUser && matchesSearch && matchesLine && matchesJour;
                }).toList();
                        ...
                        subtitle: Column(
                          ...
                          children: [
                            ...
                            Text("${AppLocalizations.of(context)!.line}: ${trajet['lineId']}",
                                style: const TextStyle(color: Colors.black87)),
                            Text("${AppLocalizations.of(context)!.dayOfOperation}: ${trajet['jourDeCirculation']}",
                                style: const TextStyle(color: Colors.black87)),
                          ],
                        ),
                      ),
