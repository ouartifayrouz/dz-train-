...
class _NotificationsScreenState extends State<NotificationsScreen> {
  ...
  // Simule la vérification des trajets partant dans 10 minutes — remplace par ta logique réelle
  Future<List<String>> _getTrajetsPartantDans10Minutes() async {
    await Future.delayed(Duration(seconds: 1)); // simuler délai réseau
    // Retourne une liste non vide pour afficher l’alerte, ou vide si rien à signaler
