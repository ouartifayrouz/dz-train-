...
import 'package:dztrainfay/trajet_notifier.dart'; // Ajouté pour les notifications de trajet
...
// Fonction de démarrage des notifications de trajets
void startBackgroundTrajetNotifier(String username) {
  final trajetNotifier = TrajetNotifier();
  Timer.periodic(const Duration(minutes: 1), (_) async {
    await trajetNotifier.checkAndNotify(username);
  });
}
...
void main() async {
  ...
  // Vérifie si l'utilisateur est connecté (dans Firestore)
  ...
  // Démarre le système de notification en arrière-plan si connecté
  if (loggedIn) {
    startBackgroundTrajetNotifier(username);
  }
